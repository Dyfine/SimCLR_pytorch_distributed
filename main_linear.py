...
from util import set_optimizer, set_stream_logger, set_file_logger
...
def parse_option():
    ...
    conf_work_path = 'classifier_' + now_time + '_'
...
def main():
    ...
    for epoch in range(1, opt.epochs + 1):
        ...
        loss, acc, acc5 = train(train_loader, model, classifier, criterion,
                          optimizer, epoch, opt)
        time2 = time.time()
        logging.info('Train epoch {}, total time {:.2f}, accuracy:{:.2f}'.format(
        ...
        # eval for one epoch
        loss, val_acc, val_acc5 = validate(val_loader, model, classifier, criterion, opt)
    ...
    logging.info('best accuracy: {:.2f}, accuracy5: {:.2f}'.format(best_acc, best_acc5))
